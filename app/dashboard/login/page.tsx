      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-10">
        <div className="card w-full max-w-sm animate-pop-in">
          <div className="mb-5 flex flex-col items-center gap-2 text-center">
            ...
            <h1 className="font-display text-xl font-semibold text-[color:var(--text-primary)]">Log Masuk</h1>
            <p className="text-sm text-[color:var(--text-secondary)]">Masukkan username &amp; PIN dashboard anda.</p>
          </div>
