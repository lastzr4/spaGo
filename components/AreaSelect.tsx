  ...
  return (
    <>
      ...
      >
        ...
        <span className={value ? "truncate text-brand-900" : "truncate text-gray-400"}>{value || placeholder}</span>
      </button>
      ...
      {open && (
        ...
        >
          <div
            className="safe-bottom flex max-h-[80vh] w-full max-w-md flex-col rounded-t-3xl bg-white p-5 animate-modal-in sm:max-w-lg"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="mb-3 flex items-center justify-between">
              <p className="text-sm font-semibold text-brand-900">Pilih kawasan</p>
