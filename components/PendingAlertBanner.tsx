...
export default function PendingAlertBanner({ token, pendingCount }: { token: string; pendingCount: number }) {
  ...
  return (
    <Link
      ...
      className="card-tap mb-5 flex animate-fade-in items-center gap-3 rounded-2xl border border-amber-500/30 bg-amber-500/15 p-4"
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-xs text-amber-400/80">Sahkan atau batalkan secepat mungkin</p>
      </div>
